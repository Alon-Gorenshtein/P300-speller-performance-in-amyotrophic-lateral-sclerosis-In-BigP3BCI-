...
| | Model performance | 16 | Performance measures with confidence intervals | Results, Estimation Error and Its Reference Points (pooled measures); Results, Transportability (per-cohort heterogeneity, including Brier skill; Table 2; Figures 1-4) |
