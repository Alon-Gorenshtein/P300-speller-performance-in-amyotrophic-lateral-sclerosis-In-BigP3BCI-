...
The requested alignment, nonlinear-decoder, and local-recalibration analyses necessarily added material to the Methods and Results, but the Discussion itself is now materially leaner and no longer presents a parallel numerical summary of the Results.
