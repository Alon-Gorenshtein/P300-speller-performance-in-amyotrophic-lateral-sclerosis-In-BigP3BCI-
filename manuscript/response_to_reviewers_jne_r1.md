...
- **Length.** Redundant statistics were removed from the Discussion and the clustered-sandwich-versus-bootstrap estimator comparison was moved to the Supplement, as Reviewer 1 suggested; the three new analyses the reviewers requested increased the net main-text length from approximately 6,600 to 8,600 words.
